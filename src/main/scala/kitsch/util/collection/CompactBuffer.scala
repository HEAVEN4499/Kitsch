package kitsch.util.collection

import scala.reflect.ClassTag

/**
 * Created by wulicheng on 16/3/26.
 */
private[kitsch] class CompactBuffer[T: ClassTag] extends Seq[T] with Serializable {
...
private[kitsch] object CompactBuffer {
